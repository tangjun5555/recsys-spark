 ...
 */
@Since("1.1.0")
class CustomWord2Vec extends Serializable with Logging {
   ...
   */
  @Since("1.1.0")
  def fit[S <: Iterable[String]](dataset: RDD[S]): CustomWord2VecModel = {
  ...
  private def doFit[S <: Iterable[String]](
    ...
    new CustomWord2VecModel(wordArray.zipWithIndex.toMap, syn0Global)
  }
   ...
   */
  @Since("1.1.0")
  def fit[S <: JavaIterable[String]](dataset: JavaRDD[S]): CustomWord2VecModel = {
 ...
 */
@Since("1.1.0")
class CustomWord2VecModel private[spark] (
  ...
  def this(model: Map[String, Array[Float]]) = {
    this(CustomWord2VecModel.buildWordIndex(model), CustomWord2VecModel.buildWordVectors(model))
  }
  ...
  def save(sc: SparkContext, path: String): Unit = {
    CustomWord2VecModel.SaveLoadV1_0.save(sc, path, getVectors)
  }
...
@Since("1.4.0")
object CustomWord2VecModel extends Loader[CustomWord2VecModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def load(sc: SparkContext, path: String): CustomWord2VecModel = {
      ...
      new CustomWord2VecModel(word2VecMap)
    }
  ...
  @Since("1.4.0")
  override def load(sc: SparkContext, path: String): CustomWord2VecModel = {
